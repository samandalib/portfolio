    ...
    <main className="flex-1 flex items-center justify-center px-8 py-12">
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start">
          <div className="flex flex-col md:flex-row items-center lg:items-start gap-8 lg:gap-12">
            {/* Profile Image */}
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <p className="text-lg md:text-xl font-light max-w-lg text-center lg:text-left text-foreground-light dark:text-foreground-dark leading-relaxed">
